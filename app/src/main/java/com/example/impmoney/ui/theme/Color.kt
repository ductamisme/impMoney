package com.example.impmoney.ui.theme

import androidx.compose.ui.graphics.Color

val LightBlue = Color(0xFF3B7CEC)
val red = Color(0xFFE93F59)
val scarlet = Color(0xFFE70000)
val newGrey = Color(0xA3FCFCFC)
...
val blueWhite = Color(0xFFE8F4FA)
